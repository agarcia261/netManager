            ...
            <div className="card horizontal">
              <div className="card-stacked">
                <div className="card-content">
                  <p>
                    Sap: {mirrorArr.sap} Created on: {mirrorArr.createdOn}{" "}
                    Expiration: {mirrorArr.expiration}{" "}
                  </p>
                  ...
                  <button
                    ...
                    onClick={() => props.deleteMirror(mirrorArr._id)}
                    type="submit"
                    name="action"
                  >
                    X{/* <i className="material-icons right">add_circle</i> */}
                  </button>
                </div>
              </div>
            </div>
